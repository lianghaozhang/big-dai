  ...
  height: auto;">
    ...
    <div class="outTable">
      <el-table  :data="tableData.filter(data => !search || data.name.toLowerCase().includes(search.toLowerCase()))" style="width:100%" v-loading="loading">
        ...
        <el-table-column prop="name" label="汽车品牌" width="180" />
        <el-table-column prop="skill" label="编号" width="180" />
        <el-table-column prop="address" label="厂家4S门店" width="180" />
        <el-table-column width="180">
          <template #header="scope">
								<el-input v-model="search" size="default" placeholder="输入汽车品牌搜索" />
							</template>
      ...
      <div class="mask" v-if="isShowMaskEdit">
        <div class="mask_white">
          ...
          <el-input v-model="FormData.name" placeholder="请输入汽车品牌"></el-input>
          <el-input v-model="FormData.skill" placeholder="请输入编号"></el-input>
          <el-input v-model="FormData.address" placeholder="请输入厂家4S门店"></el-input>
