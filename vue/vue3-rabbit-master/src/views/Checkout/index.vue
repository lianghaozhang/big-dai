...
import {createAddressAPI,deleteAddressAPI} from '@/apis/address.js'
...
const deleteAddress = async (id)=>{
  ...
  // checkInfo.value.userAddresses =  checkInfo.value.userAddresses.filter((item)=>{
  //   // console.log(item.id);
  //   return item.id != res.result.id
  // })
  console.log(res);
  getCheckInfo()
  // console.log(nweAddress.value);
}
...
<template>
    ...
    <div class="addressWrapper">
      ...
      >
        <ul>
          ...
          <el-button size="default" @click="deleteAddress(item.id)">删除地址</el-button>
  ...
  <el-dialog v-model="dialogFormVisible" title="添加收获地址">
    <el-form :model="form">
